...
const cloudinaryWatermarked = (publicId) => {
  ...
  const t = ["w_800,c_limit,q_auto,f_auto","l_Strang_Hall_Beer_Fest_logo_quovap","w_150,o_35,g_south_east,x_15,y_15","fl_layer_apply"].join("/");
  return `${base}/${t}/${publicId}`;
};
const cloudinaryThumb = (publicId) =>
  `https://res.cloudinary.com/${CLOUDINARY_CLOUD}/image/upload/w_300,h_300,c_fill,q_auto,f_auto/l_Strang_Hall_Beer_Fest_logo_quovap/w_60,o_35,g_south_east,x_6,y_6/fl_layer_apply/${publicId}`;
